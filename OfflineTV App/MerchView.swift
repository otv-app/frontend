...
struct MerchView: View {
    ...
    let streamerMerchInfo: [StreamerMerch] = [
        ...
        .init(id: 2, streamer: "Pokimane", merches: [.init(id: 0, price: 0.99, image: "gasPoki", link: "https://www.google.com/"), .init(id: 1, price: 2.99, image: "uwuPoki", link: "https://www.google.com/")]),
        .init(id: 3, streamer: "DisguisedToast", merches: [.init(id: 0, price: 10.99, image: "toast", link: "https://disguisedtoast.com/")])
    ]
